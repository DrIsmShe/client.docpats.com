...
(function (t, e) {
  ...
  // Add more Bootstrap methods and components here as needed
...
!(function (t, e) {
  ...
  const vi = Object.freeze(
    ...
    Di = `keyup${wi}${Ai}`,
    $i = "show",
    Ii = '[data-bs-toggle="dropdowns"]:not(.disabled):not(:disabled)',
    Ni = `${Ii}.${$i}`,
    Pi = ".dropdown-menu",
  ...
  class Ks extends W {
    ...
    _toggleDropDown(t, e) {
      ...
      if (!i.classList.contains("dropdowns")) return;
      const n = (t, n) => {
...
TynApp = (function (TynApp) {
  ...
  TynApp.onMobile = navigator.userAgent.match(
