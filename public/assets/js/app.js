!(function (TynApp) {
  ...
  TynApp.Appbar = function () {
    ...
    if (elm) {
      document
        .querySelector(".tyn-root")
        .style.setProperty("--appbar-height", `${elm.offsetHeight}px`);
    }
  };
  ...
  TynApp.Chat = {
        ...
        chatSend &&
          chatSend.addEventListener("click", function (event) {
            ...
            if (
              ...
              getInput !== "" &&
                chatReply
                  .querySelector(".tyn-reply-item .tyn-reply-group")
                  .insertAdjacentHTML("beforeend", chatBubble);
            } else {
              getInput !== "" &&
                chatReply
                  .querySelector(".tyn-reply-item .tyn-reply-group")
            ...
            chatInput.innerHTML = "";
            let simpleBody = SimpleBar.instances.get(
              document.querySelector("#tynChatBody")
            );
      ...
      if (elm) {
        elm.forEach((item) => {
          item.addEventListener("click", (e) => {
            ...
            !isOption &&
              document.getElementById("tynMain").classList.toggle("main-shown");
          });
        });
      }
    },
    ...
    mute: function () {
      ...
      const muteOptionsModal =
        muteToggle && new bootstrap.Modal("#muteOptions", {});
      if (muteToggle) {
    ...
    aside: function () {
      ...
      if (elm) {
        ...
        target.insertAdjacentHTML(
          "beforebegin",
          `<div class="tyn-overlay js-toggle-chat-options" ></div>`
        );
        let overlay = document.querySelector(
          ".tyn-overlay.js-toggle-chat-options"
        );
    ...
    botsend: function () {
      ...
      chatSend &&
        chatSend.addEventListener("click", function (event) {
          ...
          chatInput.innerHTML = "";
          let simpleBody = SimpleBar.instances.get(
            document.querySelector("#tynBotBody")
          );
          let height = chatBody.querySelector(
            ".simplebar-content > *"
          ).scrollHeight;
      ...
      stories: function () {
        ...
        storiesSlider &&
          storiesSlider
            ...
            .style.setProperty("--slide-delay", `${autoplayDelay}ms`);
        const thumbCount =
          storiesThumb && storiesThumb.querySelectorAll(".swiper-slide").length;
  ...
  TynApp.Theme = function () {
    ...
    themeModeToggle.forEach((item) => {
      item.value == localStorage.getItem("connectme-html") &&
        (item.checked = true);
