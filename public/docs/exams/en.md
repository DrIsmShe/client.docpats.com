...
An attempt is in one of the following states: **in progress**, **submitted**, **time expired**,
or **abandoned**. If time runs out, the attempt is submitted automatically — answers
are not lost.
...
- the result for each topic is weighted according to its share in the structure of the actual
