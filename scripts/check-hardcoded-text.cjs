...
const ALLOWED = new Set([
  ...
  "DP-Videra",
  "DP-Tube",
  // Идентификаторы научной публикации в дайджесте. Это не подписи, а имена
  // указателей: DOI и PMID пишутся так в любой стране и на любом языке.
  "DOI:",
  "PMID:",
  // Аббревиатура защищённых медданных — термин, одинаковый во всех языках.
  "PHI",
  "AI",
  "ID",
  "XP",
