import { знакомыйКорень, служебныйАдрес } from "./lib/public-routes.js";
...
export const config = {
  path: [
    ...
    "/:slug",
    // Все прочие адреса — чтобы отвечать 404 там, где страницы нет.
    // Без этого шаблона функция до незнакомых путей просто не доходила, и
    // Netlify отдавал на них оболочку со статусом 200.
    "/*",
