...
export const createDrugItem = (data) => axios.post(DRUG_BASE, data);
...
export const createRequisition = (data) => axios.post(REQ_BASE, data);
...
export const submitRequisition = (id) => axios.post(`${REQ_BASE}/${id}/submit`);
...
export const dispense = (data) =>
  axios.post("/api/v1/clinic/pharmacy/dispense", data);
...
export const getDispenseReportPdf = (params = {}) =>
  axios.get("/api/v1/clinic/pharmacy/reports/dispense.pdf", {
    params,
    responseType: "blob",
  });
