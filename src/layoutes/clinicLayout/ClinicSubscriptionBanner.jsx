...
// Роли, которые распоряжаются оплатой. admin включён намеренно: в этой
// системе он заместитель владельца и ведёт настройки клиники. Если
// владелец заходит раз в месяц, а полосу видит только он, клиника
// замёрзнет молча.
