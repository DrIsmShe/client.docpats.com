...
const STYLES = `
  ...
  *, *::before, *::after { box-sizing: border-box; margin: 0; padding: 0; }
  ...
  /* Logo — centred absolutely like news page */
  .dp-nav-logo {
    position: absolute;
    left: 50%;
  ...
  /* ════ METRICS BAR ════ */
  .dp-metrics-bar { background: white; border-bottom: 1px solid var(--border); }
  .dp-metrics-inner {
    max-width: 1280px; margin: 0 auto;
  ...
  /* Feature cards */
  .dp-features-grid { display: grid; grid-template-columns: repeat(auto-fit, minmax(240px, 1fr)); gap: 14px; }
  .dp-feature-card {
  ...
  @media (max-width: 768px) {
    .dp-topbar { padding: 0 20px; font-size: 9px; }
    .dp-nav-inner { padding: 0 20px; }
    .dp-nav-links { display: none; }
    .dp-hero { padding: 48px 0 80px; }
    .dp-hero-inner { padding: 0 20px; gap: 0; }
    .dp-portal-ctas { flex-direction: column; }
    .dp-portal-btn { flex: none; width: 100%; }
    .dp-section { padding: 60px 20px; }
    .dp-logos-bar, .dp-footer { padding-left: 20px; padding-right: 20px; }
    .dp-metrics-inner { grid-template-columns: repeat(2, 1fr); }
    .dp-metric-cell { padding: 22px 14px; }
    .dp-seo { padding: 48px 20px; }
  }
  @media (max-width: 480px) {
    .dp-topbar { display: none; }
    .dp-hero-title { font-size: 32px; }
    .dp-roles-grid { grid-template-columns: 1fr; }
    .dp-compliance-badges { grid-template-columns: 1fr; }
        ...
        <nav className="dp-nav">
          <div className="dp-nav-inner">
            ...
            <div className="dp-nav-links">
              ...
              <a className="dp-nav-link" href="#features">
                Platform
              </a>
              <a className="dp-nav-link" href="#compliance">
                Security
              </a>
            </div>
            ...
            <div className="dp-nav-right">
              <LanguageSwitcher />
              <Link to="/registration" className="dp-nav-sign-in">
                Sign In
              </Link>
            </div>
          </div>
