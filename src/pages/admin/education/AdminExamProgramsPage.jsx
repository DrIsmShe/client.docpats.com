          ...
          <div key={program._id} className="edu-card">
            ...
            <div className="edu-prog-settings">
              ...
              <label className="edu-prog-setting">
                ...
                >
                  {/* ЯЗЫК ОРИГИНАЛА, а не «единственный язык витрины».
                      Раньше это поле решало, на каком языке тест виден в
                      каталоге; теперь название и описание переводятся вместе
                      с вопросами, и тест виден везде, где у него есть
                      вопросы. Здесь остаётся то, ОТ ЧЕГО переводить и к чему
                      откатываться, когда перевода нет.
                      Пусто = определить по содержимому: берётся первый язык
                      из languages, посчитанный по банку вопросов. */}
                  <option value="">
