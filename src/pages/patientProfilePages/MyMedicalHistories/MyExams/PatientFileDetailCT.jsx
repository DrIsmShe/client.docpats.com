...
/* ===================== Основной компонент ===================== */
export default function PatientFileDetailCT() {
  ...
  const handleDownloadPDF = async () => {
    ...
    if (imgH <= pageH - margin * 2) {
      ...
      pdf.save(`ct-summary-${item?._id || "report"}.pdf`);
      return;
    }
  ...
  useEffect(() => {
    ...
    async function run() {
      ...
      setError("");
      try {
        const url = `${BASE_URL}/patient-profile/get-my-ct-file-details/files/${encodeURIComponent(
          id,
        )}`;
  ...
  const dobDisplay = useMemo(() => fmtDOBWithAge(item?.patientId), [item]);
              ...
              >
                <div>
                  ...
                  <KV
                    ...
                    value={getDisplayName(item.patient)}
                  />
