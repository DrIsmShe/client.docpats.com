...
export default function TempAnamnesisVitae() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post(
        `${API_BASE}/clinic/temp-anamnesis-vitae`,
        formData,
      ...
      setMessage(
        error.response?.data?.message ||
          t("tempAnamnesisVitae.messages.submitError")
      );
    }
  };
                    ...
                    <form onSubmit={handleSubmit}>
                      ...
                      <div className="row mb-3">
                        <label className="col-md-4 col-lg-2 col-form-label">
                          {t("tempAnamnesisVitae.fields.title")}
                        </label>
                      ...
                      <div className="row mb-3">
                        <label className="col-md-4 col-lg-2 col-form-label">
                          {t("tempAnamnesisVitae.fields.content")}
                        </label>
                        <div className="col-md-8 col-lg-10">
                          <textarea
                            name="content"
                      ...
                      <div className="row mb-3">
                        <label className="col-md-4 col-lg-2 col-form-label">
                          {t("tempAnamnesisVitae.fields.tags")}
                        </label>
                        <div className="col-md-8 col-lg-10">
                          <textarea
                            name="tags"
                      ...
                      <div className="row mb-3">
                        <div className="col-md-8 offset-md-4 col-lg-10 offset-lg-2">
                          <button type="submit" className="btn btn-primary">
                            {t("tempAnamnesisVitae.buttons.submit")}
                          </button>
                        </div>
                      </div>
                    </form>
