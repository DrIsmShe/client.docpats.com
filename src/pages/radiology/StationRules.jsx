      ...
      <div className="rules-block">
        ...
        <ul className="rules-list">
          ...
          {policy?.variantCount > 0 && (
            <li>
              У этого кейса есть <strong>числовые варианты</strong> (
              {policy.variantCount + 1} набора данных, считая основной): при повторном
              прохождении цифры будут другими, а диагноз тем же. Поэтому ответ,
              подсмотренный у коллеги, может не подойти — значимым окажется другой
              показатель.
            </li>
          )}
        </ul>
