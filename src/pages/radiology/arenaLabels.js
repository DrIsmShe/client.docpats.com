...
// Русские подписи для админки тренажёра. Вьюеры кейсов с них уже сняты и
// читают словарь; админка остаётся на русском по решению владельца — её ведёт
// один человек, и перевод четырёх языков там был бы работой вхолостую.
// Не используйте эти карты в экранах для врачей: подпись отсюда останется
// русской в арабской версии. Там — modalityLabel(t, key) и t(difficulty).
