...
const styles = `
  ...
  .video-modal-dl:hover { background: rgba(255,255,255,0.25); }
  .video-modal-close {
    position: absolute;
    top: -14px;
    right: -14px;
  ...
  .video-modal-close:hover { background: rgba(229,62,62,0.6); }
...
function ChatWindow({
  ...
  const [zoomVideo, setZoomVideo] = useState(null); // { url, name }
    ...
    <>
      ...
      <div className="chat-wrapper">
        ...
        <div className="chat-container">
          ...
          {/* VIDEO MODAL — полноценный inline-плеер */}
          {zoomVideo && (
            <div
