...
const styles = `
  ...
  .dp-input.email-only { padding-left: 42px; padding-right: 13px; }
...
export default function ResetPasswordChange() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (password !== repeatPassword) {
      setErrorMessage(t("ResetPasswordChange.errors.notMatch"));
      return;
    }
    try {
      const response = await axios.post(
        `${API_BASE}/auth/Must-Change-Password-true`,
        {
          email,
      ...
      setErrorMessage(
        error.response?.data?.message ||
          t("ResetPasswordChange.errors.unexpected"),
      );
      setSuccessMessage("");
    }
  };
      ...
      <div className="dp-rpc-root">
        ...
        <div className="dp-card">
          ...
          <div className="dp-brand">
            ...
            <div className="dp-brand-tag">Новый пароль</div>
          </div>
          ...
          <div className="dp-title">
            {t("ResetPasswordChange.title") || "Смена пароля"}
          </div>
          <div className="dp-subtitle">
            {t("ResetPasswordChange.subtitle") ||
          ...
          <form onSubmit={handleSubmit} noValidate>
            ...
            <div className="dp-field">
              <label className="dp-label">
                {t("ResetPasswordChange.email") || "Email"}
              </label>
            ...
            <div className="dp-field">
              <label className="dp-label">
                {t("ResetPasswordChange.newPassword") || "Новый пароль"}
              </label>
              <div className="dp-input-wrap">
                <span className="dp-input-icon">🔑</span>
                <input
            ...
            <div className="dp-field">
              <label className="dp-label">
                {t("ResetPasswordChange.repeatPassword") || "Повторите пароль"}
              </label>
              <div className="dp-input-wrap">
                <span className="dp-input-icon">🔑</span>
                <input
            ...
            <button className="dp-btn" type="submit">
              {t("ResetPasswordChange.submit") || "Сохранить новый пароль →"}
            </button>
          </form>
