    ...
    <div className="dg-page">
      ...
      <header className="dg-head">
        <div className="dg-head-main">
          {/* «Второе мнение», а не «Диагностическая помощь»: в меню врача рядом
              стоит «Тренажёр диагностики», и два похожих названия он спутает. А
              спутать здесь означает открыть тренажёр, думая, что разбирает
              своего пациента, или наоборот. */}
          <p className="edu-eyebrow">Материалы реального пациента</p>
          <h1 className="dg-title">Второе мнение</h1>
          <p className="dg-subtitle">
            Разбор заключений, анализов и клинических случаев: что стоит перепроверить, чего
            не хватает в данных и что нельзя пропустить. Итог по делу пишет и подписывает
            врач.
          </p>
        </div>
      </header>
