    ...
    const fetchAll = async () => {
      try {
        ...
        const publicRequests = [
          axios.get(`${API_BASE}/doctor-profile/doctor-detail/${id}`, {
            withCredentials: true,
          }),
          axios.get(`${API_BASE}/doctor-profile/doctor-articles/${id}`, {
            withCredentials: true,
          }),
        ];
          ...
          <div className="dd-card">
            <div className="dd-card-body">
              {/* Врач на СВОЕЙ странице.
                  ...
                  достоверно. Раньше владельцу предлагали написать самому себе
                  и добавить себя в друзья — бэкенд такие запросы отклоняет, но
                  кнопка, которая заведомо не сработает, выглядит поломкой. */}
