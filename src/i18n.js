...
i18n
  ...
  .init({
    ...
    ns: [
      ...
      "patientArea",
      // Рубрика конференций — публичная страница, на которую ведут ссылки из
      // писем. Внешний посетитель не должен увидеть на первом кадре ключи
      // вместо заголовков; словарь маленький, полтора килобайта.
      "conferences",
    ],
    defaultNS: "common",
