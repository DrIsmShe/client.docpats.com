...
const STYLES = `
  ...
  /* Арабский: сайдбар переезжает направо, и пилюля оказывается ровно
     ...
     Физическими свойствами, а не inset-inline-end, намеренно: пилюлю
     перетаскивают, и при перетаскивании JS выставляет инлайном
     left/right. Смешивать их с логическими значит полагаться на тонкости
     каскада там, где цена ошибки — сломанное перетаскивание. */
