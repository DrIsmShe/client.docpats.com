...
const DoctorProcedureBookingPage = lazy(() => import("./pages/doctorProfilePages/procedures/DoctorProcedureBookingPage.jsx"));
const DoctorProceduresJournalPage = lazy(() => import("./pages/doctorProfilePages/procedures/DoctorProceduresJournalPage.jsx"));
        ...
        >
          ...
          <Suspense fallback={<RouteFallback />}>
            ...
            <Route path="/doctor" element={<DoctorpofileLayout />}>
              {/* Студия медицинских фильмов. Без DoctorOnlyRoute намеренно:
              ...
              {/* Запись на операцию или обследование — ОТДЕЛЬНАЯ сущность,
                  а не режим записи на приём: у вмешательства другая
                  длительность, подготовка и жизненный цикл (см. комментарий в
                  server/common/models/Procedure/procedureBooking.js). Время при
                  этом общее: операция занимает его и для приёмов. */}
              <Route
                path="book-procedure"
                element={<DoctorProcedureBookingPage />}
              />
              <Route
                path="procedures"
                element={<DoctorProceduresJournalPage />}
              />
