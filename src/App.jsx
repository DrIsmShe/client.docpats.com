...
import PricingCheckoutPage from "./pages/payments/PricingCheckoutPage";
import MockCheckoutPage from "./pages/payments/MockCheckoutPage";
// Подготовка к экзаменам (modules/education на бэкенде)
import ExamCatalogPage from "./pages/education/ExamCatalogPage";
import ExamProgramPage from "./pages/education/ExamProgramPage";
import ExamAttemptPage from "./pages/education/ExamAttemptPage";
// Управление тестами — только из админ-панели (см. блок роутов admin).
import AdminExamImportPage from "./pages/admin/education/AdminExamImportPage";
      ...
      <GlobalCallProvider currentUserId={currentUserId}>
        ...
        >
          <Routes>
            ...
            {/* Подготовка к экзаменам. Страницы самозащищаются: 401 от
                /api/v1/education уводит на /login, как и остальные зоны. */}
            <Route path="/education" element={<ExamCatalogPage />} />
            <Route
              path="/education/programs/:programId"
              element={<ExamProgramPage />}
            />
            <Route
